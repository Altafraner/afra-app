...
public class TypstTemplateGenerator : IIncrementalGenerator
{
    ...
    {
        var textFiles = context.AdditionalTextsProvider.Where(static file => file.Path.EndsWith(".typ"));
