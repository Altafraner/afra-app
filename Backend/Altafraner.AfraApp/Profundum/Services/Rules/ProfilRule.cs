...
public class ProfilRule : IProfundumIndividualRule
{
        ...
        LinearExprBuilder objective)
    {
        ...
        // Rule 1: hard gate - a Profil var may only be 1 in a slot this grade is allowed to enroll in.
        ...
        // Rule 3: hard constraint - at most one Profilprofundum per Einwahlzeitraum.
    ...
    public IEnumerable<MatchingWarning> GetWarnings(Person student, IEnumerable<ProfundumSlot> slots, IEnumerable<ProfundumEinschreibung> enrollments)
    {
        ...
        // Rule 3: at most one Profilprofundum per Einwahlzeitraum.
