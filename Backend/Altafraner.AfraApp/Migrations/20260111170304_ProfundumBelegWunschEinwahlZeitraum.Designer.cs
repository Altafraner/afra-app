...
namespace Altafraner.AfraApp.Migrations
{
    ...
    [Migration("20260111170304_ProfundumBelegWunschEinwahlZeitraum")]
    partial class ProfundumBelegWunschEinwahlZeitraum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Altafraner.AfraApp.Profundum.Domain.Models.Bewertung.ProfundumFeedbackAnker", b =>
                {
                    ...
                    b.ToTable("ProfundumFeedbackAnker");
                });
            ...
            modelBuilder.Entity("Altafraner.AfraApp.Profundum.Domain.Models.Bewertung.ProfundumFeedbackEntry", b =>
                {
                    ...
                    b.ToTable("ProfundumFeedbackEntries");
                });
            ...
            modelBuilder.Entity("Altafraner.AfraApp.Profundum.Domain.Models.Bewertung.ProfundumFeedbackKategorie", b =>
                {
                    ...
                    b.ToTable("ProfundumFeedbackKategories");
                });
            ...
            modelBuilder.Entity("PersonProfundumInstanz", b =>
                {
                    ...
                    b.ToTable("PersonProfundumInstanz");
                });

            modelBuilder.Entity("ProfundumFeedbackKategorieProfundumKategorie", b =>
                {
                    b.Property<Guid>("KategorienId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ProfundumFeedbackKategorieId")
                        .HasColumnType("uuid");

                    b.HasKey("KategorienId", "ProfundumFeedbackKategorieId");

                    b.HasIndex("ProfundumFeedbackKategorieId");

                    b.ToTable("ProfundumFeedbackKategorieProfundumKategorie");
                });
            ...
            modelBuilder.Entity("ProfundumFeedbackKategorieProfundumKategorie", b =>
                {
                    b.HasOne("Altafraner.AfraApp.Profundum.Domain.Models.ProfundumKategorie", null)
                        .WithMany()
