    ...
    public partial class Freistellung : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:freistellungs_status", "abgelehnt,bei_sekretariat,beim_schulleiter,elternbestaetigung_ausstehend,elternbestaetigung_eingereicht,gestellt,schulleiter_bestaetigt")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    elternbestaetigung_hinweis = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    in_cevex_eingetragen = table.Column<bool>(type: "boolean", nullable: false),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterDatabase()
                ...
                .OldAnnotation("Npgsql:Enum:freistellungs_status", "abgelehnt,bei_sekretariat,beim_schulleiter,elternbestaetigung_ausstehend,elternbestaetigung_eingereicht,gestellt,schulleiter_bestaetigt")
