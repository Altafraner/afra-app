...
{
    /// <inheritdoc />
    public partial class Freistellung : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:freistellungs_status", "abgelehnt,abgeschlossen,bei_sekretariat,beim_schulleiter,eingereicht,elternbestaetigung_eingereicht,genehmigt,wartet_auf_eltern")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    elternbestaetigung_erforderlich = table.Column<bool>(type: "boolean", nullable: true),
                    elternbestaetigung_vorhanden = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    neuer_status = table.Column<FreistellungsStatus>(type: "freistellungs_status", nullable: false),
                    kommentar = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_freistellungs_verlauf", x => x.id);
                    table.ForeignKey(
                        name: "fk_freistellungs_verlauf_freistellungsantraege_freistellungsan~",
                        column: x => x.freistellungsantrag_id,
                        principalTable: "freistellungsantraege",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_freistellungs_verlauf_personen_person_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_freistellungs_verlauf_freistellungsantrag_id",
                table: "freistellungs_verlauf",
                column: "freistellungsantrag_id");

            migrationBuilder.CreateIndex(
                name: "ix_freistellungs_verlauf_person_id",
                table: "freistellungs_verlauf",
                column: "person_id");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterDatabase()
                ...
                .OldAnnotation("Npgsql:Enum:freistellungs_status", "abgelehnt,abgeschlossen,bei_sekretariat,beim_schulleiter,eingereicht,elternbestaetigung_eingereicht,genehmigt,wartet_auf_eltern")
