...
public class AfraAppContext : DbContext, IDataProtectionKeyContext, IScheduledEmailContext<Person>
{
    ...
    /// </summary>
    public DbSet<Attendance.Domain.Models.Attendance> Attendances { get; set; }
    ...
    /// <summary>
    ///     The append-only status history of all leave requests
    /// </summary>
    public DbSet<FreistellungsVerlaufEintrag> FreistellungsVerlauf { get; set; }
    ...
    internal static Action<NpgsqlDbContextOptionsBuilder> ConfigureNpgsql =>
        builder => builder
            ...
            .MapEnum<AttendanceEntryType>("attendance_entry_type")
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Freistellungsantrag>(a =>
        {
            ...
            a.HasMany(e => e.Entscheidungen)
                ...
                .OnDelete(DeleteBehavior.Cascade);
            a.HasMany(e => e.Verlauf)
                .WithOne(v => v.Freistellungsantrag)
                .HasForeignKey(v => v.FreistellungsantragId)
                .OnDelete(DeleteBehavior.Cascade);
        });

        modelBuilder.Entity<FreistellungsVerlaufEintrag>(v => { v.HasOne(e => e.Person).WithMany(); });
