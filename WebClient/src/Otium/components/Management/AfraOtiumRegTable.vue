    ...
    <Column v-if="allowEdit" class="text-right afra-col-action">
      ...
      <template #body="{data}">
        <span class="inline-flex gap-0.5">
          <Button v-tooltip="'Bearbeiten'" aria-label="Bearbeiten" icon="pi pi-pencil"
                  severity="primary" size="small" variant="text" @click="() => edit(data)"/>
          <Button v-tooltip="'Einkürzen'" aria-label="Löschen" icon="pi pi-stop" severity="warn"
