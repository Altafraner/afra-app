...
<template>
  <template v-if="!loading">
    <Form v-if="canBeShortened" class="flex flex-col gap-3" @submit="onSubmit">
      ...
      <p>
        Durch das Einkürzen der Wiederholung werden alle Termine nach dem neuen Enddatum abgesagt
        und gelöscht.
      </p>
      <Button label="Wiederholung einkürzen" severity="danger" type="submit"/>
    </Form>
    <p v-else>
      Die Wiederholung kann nicht weiter gekürzt werden. Sie können ggf. den ausstehenden Termin
      Absagen oder falls es
