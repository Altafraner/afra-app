...
public static class Management
{
           ...
           UserAccessor userAccessor, AfraAppContext dbContext, ILogger<ProfundumEnrollmentService> logger)
    {
        ...
        try
        {
            var result = await enrollmentService.PerformMatching(slots);
           ...
           UserAccessor userAccessor, AfraAppContext dbContext, ILogger<ProfundumEnrollmentService> logger)
    {
        ...
        try
        {
            await enrollmentService.PerformMatching(slots);
            var csv = await enrollmentService.GetStudentMatchingCSV(slots);
