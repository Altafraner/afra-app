...
public interface IAttendanceService
{
    ...
    /// <returns>
    ///     A dictionary containing the <see cref="Einschreibung">Einschreibungen</see> along with their
    ///     <see cref="AnwesenheitsStatus" />.
    /// </returns>
    ...
    public Task<Dictionary<Guid, AnwesenheitsStatus>> GetAttendanceForBlocksAsync(IEnumerable<Guid> blockIds,
        Guid personId);
